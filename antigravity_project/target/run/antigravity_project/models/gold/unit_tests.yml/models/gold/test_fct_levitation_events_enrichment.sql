...
with dbt_internal_unit_test_actual as (
  select
    "event_id","vessel_name","location_name","lead_researcher","is_levitation_event", 'actual' as "actual_or_expected"
  from (
...
dbt_internal_unit_test_expected as (
  select
    "event_id", "vessel_name", "location_name", "lead_researcher", "is_levitation_event", 'expected' as "actual_or_expected"
  from (
    select 
